                ...
                <div class="collapse navbar-collapse navbar-left">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Hire</a>
                              ...
                              <ul>
                                <li><a tabindex="-1" href="<?php echo base_url() ?>home/search_service_provider">Search Service Provider</a></li>
                        ...
                        <li class="scroll"><a href="<?php echo base_url() ?>home/search_service_provider" class="two-lines">Companies / <br />Service Provider</a></li>
