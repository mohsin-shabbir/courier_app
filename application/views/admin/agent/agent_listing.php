            ...
            <div class="row-fluid">
                <div class="span12">                    
                    ...
                    <div class="block-fluid table-sorting clearfix">
                        <table cellpadding="0" cellspacing="0" width="100%" id="agent_list_table" class="table datatable_list" >
                            <thead>
                           <tr>
                            <th width="5%">ID</th>
                            <th width="15%">Name</th>
                            ...
                            <th width="15%">Preferred Cities</th>
                          ...
                          <td><?php  if(isset($agent['address_line1']))$home_address= $agent['address_line1']; if(isset($agent['address_line2'])) $street_address=" ,  ".$agent['address_line2']; if(isset($agent['address_line3'])) $town_address=" ,  ".$agent['address_line3']; if(isset($agent['address_line4'])) $country=" ,  ".$agent['address_line4']; echo $home_address .$street_address.$town_address.$country; ?></td>
                                       ...
                                       <td>
                                        ...
                                        <a href="<?php echo site_url('admin/agents/change_status/delete/'.$agent['id']); ?>"><span class="icon-remove" title="Inactive"> </span></a> 
                                        <?php
...
jQuery(window).load(function(){
   ...
   var oTable=jQuery("#agent_list_table").dataTable();
