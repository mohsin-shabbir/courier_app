...
?>
            ...
            <div class="row-fluid">
                ...
                <div class="span8" style="margin:0 auto">                    
                  <div class="block-fluid ucard clearfix">
                                ...
                                <div class="image">
                                    ...
                                    <a href="#">
                                        <img src="<?php if(!empty($profile_image)) 
														{
															if(file_exists(AGENT_IMAGE_PATH.$profile_image))
																 echo base_url(AGENT_IMAGE_PATH)."/".$profile_image; 
															else  
																echo base_url(AGENT_THUMB_PATH)."/image_not_found.png"; 
														}
														else  
															echo base_url(AGENT_THUMB_PATH)."/placeholder.jpg"; ?>" width="100" height="100" />
                                    
                                    
                                    </a>                            
                                </div>
                                <ul class="control">                
                                    <li><span class="icon-pencil"></span> <a href="<?php echo site_url('admin/agents/save/'.$id); ?>">Edit</a></li>
                            ...
                            <div class="info">                                                                
                                <ul class="rows">
                                    <li class="heading">Agent&nbsp;&nbsp;info</li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="text"><?php echo substr($company_name,0,50); ?></div>
                                    </li>                                    
                                    <li>
                                        <div class="title">Work Experience:</div>
                                        <div class="text"><?php echo $experience_year." years ".$experience_month." months"; ?></div>
                                    </li>
                                    <li>
                                        <div class="title">Preferred Cities:</div>
                                        <div class="text"><?php echo str_replace("@"," , ",$preferred_cities); ?></div>
                                    </li>                                     
                                    <li>
                                ...
                                <div class="info table-sorting clearfix">     
                                     <table cellpadding="0" cellspacing="0" width="100%" id="agent_job_table" class="table agent_list_datatable" >
                                    	<thead>
                                           <tr>
            ...
            <div class="row-fluid">
                ...
                <div class="span12"><a class="btn btn-block" href="<?php echo site_url('admin/agents/save/'.$id); ?>" >Edit</a></div>
...
jQuery(window).load(function(){
				source='<?php echo site_url('admin/agents/agent_jobs/'.$id); ?>';
				var oTable=jQuery("#agent_job_table").dataTable({
									"bServerSide": true,
									"sServerMethod": "POST",			
			...
			if(typeof oTable != "undefined")
			{
				...
				aoColumns: [ 
							 ...
							 null,
							 null,
							{ sSelector: "#status_filter", type: "select", values: ['Awarded','Collected','Completed','Expired'] }
						]
				});
			}
});
