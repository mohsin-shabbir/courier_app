...
ul.rows li .title {
    ...
    width: 120px;
        ...
        function reg_valid()
        {
			//alert("hello");
        ////////////////////////////////////////////////////Validate User Type ////////////////////////////////////////////////////////////
        if(CKEDITOR.instances.description.getData() =="" || CKEDITOR.instances.description.getData() ==null || CKEDITOR.instances.description.getData().length  ==0)
		{	
		...
		$pagetitle = (set_value('pagetitle'))?set_value('pagetitle'):(isset($data['pagetitle'])?$data['pagetitle']:'');
	...
	<?php } ?>
              ...
              <form onSubmit="return reg_valid()" id="validation" method="POST" enctype="multipart/form-data" action="<?php echo site_url('admin/pages/save'); ?>" >         
               <div class="row-fluid">
                <div class="span11">
                <div class="span2">
                &nbsp;
                            ...
                            <div class="info"> 
                                ...
                                <ul class="rows">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                        <input type="text" onkeypress="return RestrictSpace()" id="pagename" name="pagename" class="validate[required]" value="<?php echo $pagename; ?>" />
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                        <input type="text" id="pagetitle" name="pagetitle" class="validate[required]" value="<?php echo $pagetitle; ?>"  />
                                    ...
                                    <li>
                                        <textarea   name="description" id="description" class="ckeditor required_wysiwyg validate[required]"><?php echo $description; ?></textarea>
