<script type="text/javascript" language="JavaScript">
    $(document).ready( function () {
        ...
        {
            $("#t_listing_company").dataTable({"iDisplayLength": 5, "aLengthMenu": [5,10,25,50,75,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null,null]});
        }
    });
	</script>
                ...
                <div class="span12">                    
                    ...
                    <div class="block-fluid table-sorting clearfix">
						...
						foreach($listData as $page)
							...
							{
							$url = site_url('admin/pages/save/'.$page['id']);
							...
							<tr>
								...
								<td>
								<p class="about">
								<a href="<?php echo site_url('admin/pages/save/'.$page['id']); ?>"><span class=""><img src="<?php echo base_url('application/assets/img/ic_edit.png'); ?>"  title="Edit"/></span></a> 
								<a href="<?php echo site_url('admin/pages/delete/'.$page['id']); ?>"><span class=""><img src="<?php echo base_url('application/assets/img/ic_delete.png'); ?>"  title="Delete"/></span></a>  
