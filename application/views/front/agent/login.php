...
<section id="login">
	...
	<div class="simple-panel">
        ...
        <div class="login-form">
        	<form  method="post" data-parsley-validate action="<?php echo base_url() ?>agent/login">
                <!--
                <div class="row">
                   	<div class="col-sm-12">
        ...
        <div class="lf-action-btns">
        	<a href="<?php echo base_url(); ?>agent/forget_password" class="forgot-pwd-btn left">Forgot your password?</a>
            <a href="<?php echo base_url(); ?>agent/signup" class="new-user right"><span class="fontweight500">New User?</span> Get registered now.</a>
