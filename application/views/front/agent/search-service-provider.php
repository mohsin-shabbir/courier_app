...
<script type="text/javascript" language="JavaScript" >
    $(document).ready(function() {
        ...
        $('#results').load('<?php echo base_url() ?>agent/fetch_service_provider/'+track_click, {'page':track_click}, function() {track_click++;}); //initial data to load
        $(".load_more").click(function (e) { //user clicks on button
            ...
            if(track_click <= total_pages) //make sure user clicks are still less than total pages
            {
                ...
                $.post('<?php echo base_url() ?>agent/fetch_service_provider/'+track_click,{'page': track_click}, function(data) {
