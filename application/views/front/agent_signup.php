...
<section id="signup">
	<div class="simple-panel">
        ...
        <div class="login-form signup-form">
        	 <form class="form-horizontal validation_form_UkCode" method="post"  data-parsley-validate  enctype="multipart/form-data" action="<?php echo site_url('agent/signup'); ?>"  >
                     <!-- row -->
                    <div class="row">
                        <div class="col-sm-12">
					...
					<div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name" id="company_name" value="<?php echo $company_name; ?>" placeholder="Company Name" class="field" /> 
                                    <span class="mendatory-field">*</span>
                                    <div class="clear"></div>
                                  <span class='error_red'><?php echo form_error('company_name'); ?></span>
                                </div> <!-- form group -->
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                   ...
                                   <span class='error_red'><?php echo form_error('streetUkCode1'); ?></span>
                                                            <span class="errorDivUkCode" id="streetDivUkCode1">
                                                                <span id="streetErrorUkCode1" class="txt-pink span11">* Please provide a valid Status </span>	                                                             </span>
                                </div> <!-- form group -->
                            </div>
                        </div>  
                        <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label>Preferred Cities:</label>
                                	<select class="chosen-select field" required multiple="multiple" name="preferred_cities[]" id="preferred_cities" data-placeholder="Choose cities..." >
									...
									<span class="mendatory-field">*</span>
                                <div class="clear"></div>
                             	<span class='error_red'><?php echo form_error('preferred_cities'); ?></span>
                            </div> <!-- form group -->
                        </div>
                    </div>
                    <div class="row">
...
<input type="hidden" name="get_address_uk" id="get_address_uk" value="<?php echo site_url('agent/get_address_uk'); ?>"/>
<input type="hidden" name="get_cities" id="get_cities" value="<?php echo site_url('agent/get_cities/'); ?>"/>
<script>
		var url   = "<?php echo site_url('agent/uniqueLogin'); ?>";
		var form  = 'validation';
		var type = 'agents';
		jQuery(function(){
