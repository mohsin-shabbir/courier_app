...
<section id="login">
	...
	<div class="simple-panel">
        ...
        <div class="login-form">
        	<form  method="post" data-parsley-validate action="<?php echo base_url() ?>client/login">
                <!--
                <div class="row">
                   	<div class="col-sm-12">
                ...
                <div class="row">
                	<div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="password" required data-parsley-trigger="change"  name="password"  placeholder="Enter your password" value="" class="field" /></div>
                            <div class="clear"></div>
                        </div> <!-- form group -->
                    </div>
                </div> <!-- row -->
        ...
        <div class="lf-action-btns">
        	<a href="<?php echo base_url(); ?>client/forget_password" class="forgot-pwd-btn left">Forgot your password?</a>
            <a href="<?php echo base_url(); ?>client/signup" class="new-user right"><span class="fontweight500">New User?</span> Get registered now.</a>
        </div> <!-- login form action buttons -->
        <div class="clear"></div>
    </div> <!-- simple panel -->
</section>  
