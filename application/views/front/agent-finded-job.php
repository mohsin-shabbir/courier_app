...
<script type="text/javascript" language="JavaScript" >
    ...
    $(document).ready(function() {
        $('#results').load('<?php echo base_url() ?>home/fetch_jobs/'+track_click, {'page':track_click}, function() {track_click++;}); //initial data to load
        $(".load_more").click(function (e) { //user clicks on button
            ...
            if(track_click <= total_pages) //make sure user clicks are still less than total pages
            {
                ...
                $.post('<?php echo base_url() ?>home/fetch_jobs/'+track_click,{'page': track_click,'search': $('#search').val()}, function(data) {
    ...
    <section id="search-results">
        <div class="search-form">
            <div class="search-box">
                ...
                <input type="text" id="search" class="search-field" placeholder="job  title   date  city   country  postcode">
                ...
                <div class="col-sm-3">
                    <div class="find-other-countries">
                        <div class="panel-title">
                            <h3>Find jobs <span>in other countries</span></h3>
                        </div>
                      ...
                      <div class="media-body">
                        ...
                        <div class="clear"></div>
                            <div class="action-btns">
                                <a href="#" class="more-detail">More details</a> <a href="#" class="send-quote-btn"></a>
                            </div>
                      </div> <!-- media body -->
                    </div>
                    <?php */ ?>
