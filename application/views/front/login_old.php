...
<section id="login">
	...
	<div class="simple-panel">
        ...
        <div class="login-form">
        	<form  method="post" data-parsley-validate action="<?php echo base_url() ?>user/login">
            	  <div class="row">
                   	<div class="col-sm-12">
        ...
        <div class="lf-action-btns">
        	<a href="<?php echo base_url(); ?>user/forget_password" class="forgot-pwd-btn left">Forgot your password?</a>
            <a href="<?php echo base_url(); ?>user/signup" class="new-user right"><span class="fontweight500">New User?</span> Get registered now.</a>
