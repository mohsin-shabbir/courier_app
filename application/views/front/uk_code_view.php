...
?>
				...
				<input type='hidden' name='latitudeUkCode' class="latitudeUkCode" value='<?php if(isset($latitude)) echo $latitude; ?>' id='latitudeUkCode' />
				<input type='hidden' name='longitudeUkCode' class="longitudeUkCode" value='<?php if(isset($longitude)) echo $longitude; ?>' id='longitudeUkCode' />
			</div>
          </div>
<?php
	}
     ...
     <div id='ajaxResponse' class='row-form clearfix'>
     	...
     	<div class="row-form span12">
            <div class="span3"><span class="txt_red">*</span>Longitude:</div>
           	<div class="span8">
            	<input type="text" name="longitudeUkCode<?php echo $counter; ?>" id="longitudeUkCode<?php echo $counter; ?>" value ="<?php if(isset($longitude)) echo $longitude; ?>" />
        ...
        <div class="row-form span12">
            <div class="span3"><span class="txt_red">*</span>Latitude:</div>
           	<div class="span8">
            	<input type="text" name="latitudeUkCode<?php echo $counter; ?>" id="latitudeUkCode" value ="<?php if(isset($latitude)) echo $latitude; ?>" />
