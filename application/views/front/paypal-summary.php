            ...
            <div class="col-sm-3">
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="javascript:;" class="active"><i class="icon dashboard-icon fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="javascript:;"><i class="icon notification-icon fa-fw"></i> Notifications <span class="badge">05</span></a>
                        </li>
                        <li>
                            <a href="javascript:;"><i class="icon post-icon fa-fw"></i> Post a Job</a>
                        </li>
                        <li>
                            <a href="#"><i class="icon search-client-icon fa-fw"></i> Search Service Provider</a>
                        </li>
                        <li>
                            <a href="#"><i class="icon acc-setting-icon"></i> Account Settings</a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Update Profile</a>
                                </li>
                                <li>
                                    <a href="morris.html">Change password</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="icon logout-icon fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
